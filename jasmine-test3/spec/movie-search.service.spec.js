describe('MovieSearchService', function () {
  ...
  it('should return a list of titles by relevance', function () {
    $httpBackend.whenGET('http://localhost:8080/movies/title/test/imdbVotes/-1')
      .respond(['Empire Strikes Back', 'Return of the Jedi']);
    movieSearchService.searchMoviesByType('test', 'Title', 'imdbVotes').then(function (response) {
